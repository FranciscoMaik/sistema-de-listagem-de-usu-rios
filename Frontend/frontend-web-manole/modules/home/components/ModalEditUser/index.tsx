...
export const ModalEditUser: React.FC<ModalProps> = ({ isOpen, onClose, children, updateList, userReceived }) => {
    ...
    const sendInfoNewUser = async() => {
      ...
      try {
        await api.patch(`/users/${userReceived.id}`, {
          age: user.age,
          email: user.email,
          name: user.name,
          phone: user.phone,
      ...
      <S.Overlay onClick={onClose}>
        <S.ModalContent onClick={(e) => e.stopPropagation()}>
          ...
          <div className="button">
            ...
            <S.ButtonClosed onClick={sendInfoNewUser} colorSelect="green">Atualizar</S.ButtonClosed>
          </div>
        </S.ModalContent>
      </S.Overlay>
    );
